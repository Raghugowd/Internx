                    ...
                    <tr key={application._id} className="hover:bg-gray-700/30 transition-colors">
                      <td className="px-6 py-4">
                        <div>
                          ...
                          <div className="text-gray-400 text-sm">{application.userId.college}</div>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <div>
                          <div className="text-white font-medium">{application.jobId.title}</div>
                          <div className="text-gray-400 text-sm">{application.jobId.company}</div>
                        </div>
                      </td>
                  ...
                  <div>
                    ...
                    <div className="bg-gray-700/50 rounded-xl p-4 space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-white">{selectedApplication.userId.college || 'Not specified'}</p>
                      </div>
                      <div>
                        <span className="text-gray-400 text-sm">Degree:</span>
                        <p className="text-white">{selectedApplication.userId.degree || 'Not specified'} - {selectedApplication.userId.year || 'N/A'}</p>
                      </div>
                  ...
                  <div>
                    ...
                    <div className="bg-gray-700/50 rounded-xl p-4 space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-white">{selectedApplication.jobId.company}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="text-white">₹{selectedApplication.jobId.salary.toLocaleString()}</p>
                      </div>
                      <div>
