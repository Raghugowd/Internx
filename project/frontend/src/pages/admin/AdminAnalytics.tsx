...
interface AnalyticsData {
  ...
  internshipsByDomain: Array<{ _id: string; count: number }>;
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-gray-700/50 p-6">
            ...
            <p className="text-2xl font-bold text-white mt-2">{analytics.totalInternships}</p>
            <p className="text-green-400 text-sm mt-1">{analytics.activeInternships} active</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-gray-700/50 p-6">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-white">Internships by Domain</h3>
            </div>
            
            <div className="space-y-4">
              {analytics.internshipsByDomain.map((domain, index) => {
                const percentage = analytics.totalInternships > 0 
                  ? (domain.count / analytics.totalInternships) * 100 
                  : 0;
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-gray-700/50 p-6 text-center">
            ...
            <h3 className="text-white font-semibold mb-2">Avg Applications per Internship</h3>
            <p className="text-3xl font-bold text-blue-400">
              {analytics.totalInternships > 0 
                ? Math.round(analytics.totalApplications / analytics.totalInternships)
                : 0}
            </p>
          </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-gray-700/50 p-6 text-center">
            ...
            <h3 className="text-white font-semibold mb-2">Active Internship Ratio</h3>
            <p className="text-3xl font-bold text-purple-400">
              {analytics.totalInternships > 0 
                ? Math.round((analytics.activeInternships / analytics.totalInternships) * 100)
                : 0}%
            </p>
          </div>
        </div>
